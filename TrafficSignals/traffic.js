...
function TrafficLights(){
        const myRedTime = setInterval(redLight, 3000);
            function redLight(){
                document.querySelector('#boxa').classList.remove('box3');
        ...
        const myYellowTime = setInterval(yellowLight, 6000);
            function yellowLight(){
                ...
                document.querySelector('#boxa').classList.remove('box1');
                document.querySelector('.list-red').classList.remove('red','green');
                document.querySelector('.list-yellow').classList.add('yellow');
            
        }
        const myGreenTime = setInterval(greenLight, 9000);
            function greenLight(){
                document.querySelector('#boxa').classList.remove('box2');
                document.querySelector('#boxa').classList.add('box3');
                document.querySelector('.list-red').classList.remove('yellow','red');
